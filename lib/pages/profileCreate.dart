                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: kTextFieldInputDecoration.copyWith(
                            hintText: "set a username", labelText: "Username"),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      ...
                      TextField(
                        ...
                        decoration: kTextFieldInputDecoration.copyWith(
                          hintText: "Eg: Iam a student studying in...",
                          labelText: "About",
                        ),
                      ),
                      const SizedBox(
                          ...
                          onPressed: () async {
                            if (userName.isNotEmpty &&
                              ...
                              try {
                                ...
                                showSnackBar(
                                    context, e.message.toString(), 2000);
                              }
                            } else if (userName.isEmpty ||
                                phoneNumber.isEmpty ||
                                about.isEmpty) {
                              showSnackBar(context,
                                  'Please fill in all the fields', 2000);
                            } else if (phoneNumber.length != 10 &&
                                (userName.isNotEmpty &&
                                    phoneNumber.isNotEmpty &&
                                    about.isNotEmpty)) {
                              showSnackBar(context,
                                  'Please enter a valid phone number', 2000);
                            }
                          }),
                    ],
                  ),
